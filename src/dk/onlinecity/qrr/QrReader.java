...
public class QrReader
{
	...
	public QrReader(MonochromeImage image, int w, int h, int gw, int gh) throws Exception
	{
		this.image = image;
		tCandidates = ImageUtil.calculateThresholdValues(image, w, h, gw, gh);
		tIndex = 0;
